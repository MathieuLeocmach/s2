...
Figure~\ref{fig:structurefactor} shows the increase of $S_x(q)$ toward small wavenumbers, which is well described by the asymptotic Ornstein-Zernike function in Fourier space:
\begin{equation}
