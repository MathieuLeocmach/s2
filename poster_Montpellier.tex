...
\vfill
\begin{minipage}[t][4\TPVertModule]{5.4\TPHorizModule}
...
\end{minipage}
\hfill
\begin{minipage}[t][4\TPVertModule]{9.25\TPHorizModule}
...
%\begin{minipage}[t][12.5\TPVertModule]{15\TPHorizModule}
	...
	\Head{Spatial correlation of the 50\% ``More ordered'' particles}
...
\begin{minipage}[t][4\TPVertModule]{3\TPHorizModule}
\Subhead{Structure factors}
