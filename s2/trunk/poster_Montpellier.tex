...
\begin{tikzpicture}
	\begin{axis}[%
		...
		\addplot+[Accent1,every mark/.append style={fill=Accent1}] file{figures/fig1/circles.dat};
...
\vfill
\begin{minipage}[t][1\TPVertModule]{5.4\TPHorizModule}
	\Head{Two-body order parameters}
	\Subhead{Configurational entropy\hfill Pair free energy}
\end{minipage}
\hfill
\begin{minipage}[t][1\TPVertModule]{9.25\TPHorizModule}
	\Head{Many-body order parameters}
\end{minipage}

\begin{minipage}[t][17.5\TPVertModule]{15\TPHorizModule}
