...
This problem can be overcome by calculating the correlation functions in Fourier space. These function are not oscillatory at small $q$ where we can expect and Ornstein-Zernike form, and thus much easier to fit unambiguously.
