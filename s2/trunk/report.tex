...
are in competition with icosahedral packings, and that polydispersity acts in favour of the latter ones.
...
We first note the absence of any linear coupling between two-body and multi-body order parameters.
...
for both two-body and multi-body correlation functions. While two body correlation functions do not
