...
\author{Mathieu Leocmach \footnote{e-mail address: mathieu@iis.u-tokyo.ac.jp}}
\affiliation{ {Institute of Industrial Science, University of Tokyo, 4-6-1 Komaba, Meguro-ku, Tokyo 153-8505, Japan} }
\author{John Russo \footnote{e-mail address: russoj@iis.u-tokyo.ac.jp}} 
\affiliation{ {Institute of Industrial Science, University of Tokyo, 4-6-1 Komaba, Meguro-ku, Tokyo 153-8505, Japan} }
\author{Hajime Tanaka \footnote{e-mail address: tanaka@iis.u-tokyo.ac.jp}}
\affiliation{ {Institute of Industrial Science, University of Tokyo, 4-6-1 Komaba, Meguro-ku, Tokyo 153-8505, Japan} }
...
Our aim is to compare the behaviour of both two-point quantities and multi-body quantities with
increasing pressure.
Due to the hard-sphere interaction, entropy is the only contribution to the system free energy.
All two-pair correlation quantities are thus derived from the two-body excess entropy,
defined as
$$
s_2=-\frac{\rho}{2}\int dr\left[g(r)\log(g(r))-g(r)+1\right]
$$
In principle, $s_2$ can be calculated separately for each particle in the system,
with fluctuations decaying over a typical lengthscale $\xi_{s_2}$. In practice, this
requires short time averages (on timescales comparable to the $\beta$ relaxation processes)
to compute the pair correlation function of each particle, $g_i(r)$.
...
move while holding all the other spheres fixed. It has been shown that this free
