...
\begin{figure}
	...
	\begin{groupplot}[%
		...
		%\node[below right, align=left] at (rel axis cs:0,1) {Low\\ entropy};
		...
		%\node[below left, align=right] at (rel axis cs:1,1) {High free\\ volume};
		...
		%\node[below right, align=left] at (rel axis cs:0,1) {Icosahedral};
		\node[anchor=north east, align=left, rotate=90] at (rel axis cs:0,1) {Icosahedon};
		
		\nextgroupplot[xlabel=$Q_6$, xmin=0,xmax=0.6]
		\addplot table[x index=0, y index=2]{Q6_distrib_mobility};
		%\node[below left, align=right] at (rel axis cs:1,1) {Crystalline};
		...
		%\node[below left, align=right] at (rel axis cs:1,1) {Crys-\\ talline};
		\node[anchor=south east, align=left, rotate=90] at (rel axis cs:1,1) {Crystal};
	\end{groupplot}
	\end{tikzpicture}
